...
namespace Hazel {
    ...
    static Renderer2DStorage* s_Data;//made a pointer to be able to delete it and manage it manually The pointer is created with new and destroyed with delete.
